...
from ..models.environment import GitInfo, GitStatus
...
"""
    ...
    @staticmethod
    def get_custom_node_git_info(node_path: Path) -> GitInfo | None:
        ...
        try:
            ...
            if remote_url:
                ...
                # TODO: (Use a standard util for this) Extract GitHub info if it's a GitHub URL
